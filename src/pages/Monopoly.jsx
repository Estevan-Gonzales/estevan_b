...
function Monopoly() {
  ...
  <div className="property-cc-left">
    <div className="rotate-left-full">
        Community Chest
      </div>
  </div>
  <div className="board-center"></div>
  ...
  <div className="property-body">Connecticut Avenue</div>
  <div className="property-body">Vermont Avenue</div>
  <div className="property-body">Oriental Avenue</div>
  <div className="property-body">Baltic Avenue</div>
  <div className="property-body">Medit. Avenue</div>
